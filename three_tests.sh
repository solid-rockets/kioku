...
python3 $KIOKU_PATH/test.py $1.json --max=60 --correct=1
python3 $KIOKU_PATH/test.py $1.json --max=30 --correct=2
python3 $KIOKU_PATH/test.py $1.json --max=15 --correct=4